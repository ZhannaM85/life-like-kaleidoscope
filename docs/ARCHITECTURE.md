...
Test stack: Vitest + jsdom + `fake-indexeddb` (dev dependency). 201 tests as of #10.
...
flowchart LR
    ...
    subgraph Next ["⏭ Next"]
        RANDOM["#13 Epic 10 — Random memory (Tier 5)"]
    end
    Done --> Next
```
