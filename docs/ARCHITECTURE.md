...
Test stack: Vitest + jsdom + `fake-indexeddb` (dev dependency). 146 tests as of #28.
...
flowchart LR
    ...
    subgraph Next ["⏭ Next"]
        GAL["#31 Word gallery — deliberately pick today's word (Tier 5)"]
    end
    Done --> Next
```
