...
export const ru: Dictionary = {
  ...
  memoryForm: {
    ...
    photosHint: 'Необязательно — добавьте одну-две фотографии.',
  ...
  settings: {
    ...
    restoreWord: 'Вернуть',
    yourWordsTitle: 'Ваши слова',
    yourWordsDescription:
      'Добавьте свои собственные слова дня — место, вещь, имя, которое узнаете только вы. Они участвуют в ежедневном выборе наравне с остальными.',
    addWordLabel: 'Добавить слово',
    addWordHint: 'Лучше всего работают конкретные, ощутимые слова.',
    addWord: 'Добавить',
  },
  exportPage: {
    title: 'Экспорт',
