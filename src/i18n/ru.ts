...
export const ru: Dictionary = {
  ...
  searchPage: {
    title: 'Поиск',
    description: 'Найдите воспоминание по слову, тексту, людям, местам или тегам.',
    inputLabel: 'Поиск',
    placeholder: 'Искать среди воспоминаний…',
    prompt: 'Начните вводить текст — поиск охватывает слова, истории, людей, места и теги.',
    emptyTitle: 'Ничего не найдено',
    emptyDescription: 'Попробуйте другое слово — поиск также ищет среди людей, мест и тегов.',
    loading: 'Собираем ваши воспоминания…',
    errorLoading: (error) => `Не получилось загрузить воспоминания. ${error}`,
  },
  graphPage: {
    title: 'Граф памяти',
